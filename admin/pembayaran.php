...
<head>
    ...
    <title>Kelola Metode Pembayaran - Nopia & Mino Pak Narwan</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
									...
									<li><a href="pengiriman.php">Metode Pengiriman</a></li>
                                </ul>
                            </li>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from pembayaran order by idpayment ASC");
											$no=1;
