...
<html>
<head>
<title>Nopia & Mino Pak Narwan - Checkout</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					echo '
					<li style="color:white">Halo, '.$_SESSION["role"].' '.$_SESSION["name"].'
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left1">
				<a href="index.php"><img src="images/logo.png" width="26%" height="26%"></a>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><br>Nopia & Mino Pak Narwan</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<center><h3>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Toko Kami</span></h3></center><br>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					<h3>Hubungi Kami</h3>
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jl. Jaya Sirayu No.88 Pekunden, Banyumas</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">nopiaminobanyumas@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>0812-2933-071</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Sosial Media</h3>
					<ul class="address">
						<li><i class="fa fa-instagram" aria-hidden="true"></i>NopiaMinoBanyumas</li>
						<li><i class="fa fa-twitter" aria-hidden="true"></i>NopiaMinoBanyumas</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
	...
	<div class="footer-botm">
			<div class="container" align="center">
				<div class="payment-w3ls">	
					<img src="images/kerjasama1.png" alt=" " class="img-responsive" width="60%" height="60%">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
